...
class RecordVideo(gym.Wrapper):
    ...
    def _append_frame(
        ...
        # Off until the terminations layout reaching this wrapper is pinned down: on a
        # LIBERO eval with terminations on, no panel froze.
        if self.video_cfg.get("freeze_terminated", False):
